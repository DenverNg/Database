...
where BM.TENBM ='Vi sinh' and DT.MADT ='006'
...
select DT.MADT, CD.*, GV.HOTEN, GV.NGAYSINH, GV.DIACHI
...
select GV.HOTEN
from GIAOVIEN GV join GIAOVIEN GV2 on GV.MABM=GV2.MABM
...
from GIAOVIEN GV join KHOA K on GV.MAGV=K.TRUONGKHOA
				 join BOMON BM on K.TRUONGKHOA=BM.TRUONGBM
...
select GV.*
from GIAOVIEN GV join GIAOVIEN GV2 on GV.MABM=GV2.MABM
where GV2.MAGV='002' and GV.MAGV <>'002'
